# Simplified version of the riddle used for debugging purposes.
# Allows to see the result in seconds.
# More information see in the file "full".
import time
