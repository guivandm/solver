...
all_fig_list1_5 = tuple(tuple([tuple([tuple(i) for i in ii]) for ii in iii]) for iii in all_fig_list5)

all_fig_list6 = tuple(sorted(all_fig_list1_5, key=len))
...
l9 = all_fig_list6[8]
l10 = all_fig_list6[9]
l11 = all_fig_list6[10]
l12 = all_fig_list6[11]
